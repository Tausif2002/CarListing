import { getCartItemQty, getCurrentUser, getUserCart, saveUserCart } from "./cartUtils.js";
  ...
  filteredCars.forEach((car) => {
    ...
    div.innerHTML = `
      ...
      <div class="card-body">
        ...
        <h4><a class="car-title" href="carDetails.html?id=${car.id}">${car.year} ${car.title}</a></h4>
        ...
        <div class="info">
          ...
          <div class="engine-type info-item">
            <img  class="#car-img" src="./public/images/engine.svg" />
            <p>2,350 (cc)</p>
          </div>
        </div>
      </div>
