export const cars = [
    // SUVs
    {
      ...
      title: "Toyota RAV4 - Adventure Awaits", isNew: true, location: "Denver",stock:5
    },
    {
      ...
      title: "Ford Explorer - Built for the Wild", isNew: false, location: "Chicago",stock:4
    },
    {
      id: 3, brand: "Honda", model: "CR-V", year: 2023, mileage: 90, maxSpeed: 190,
      price: 3000000, oldPrice: 3150000, image: "honda-crv.jpg", type: "SUV",
      title: "Honda CR-V - Comfort and Reliability", isNew: true, location: "San Francisco",stock:6
    },
    {
      ...
      title: "Chevy Tahoe - Rugged and Ready", isNew: false, location: "Dallas",stock:3
    },
    ...
    // Sedans
    {
      ...
      title: "Nissan Altima - Sleek and Smart", isNew: true, location: "Miami",stock:5
    },
    {
      ...
      title: "Hyundai Sonata - Elegance Redefined", isNew: false, location: "Phoenix",stock:7
    },
    {
      ...
      title: "Toyota Camry - Confidence in Motion", isNew: true, location: "Seattle",stock:8
    },
    {
      id: 8, brand: "Kia", model: "K5", year: 2022, mileage: 90, maxSpeed: 195,
      price: 2600000, oldPrice: 2750000, image: "kia-k5.jpg", type: "Sedan",
      title: "Kia K5 - Future of Driving", isNew: true, location: "Las Vegas",stock:4
    },
    ...
    // Coupes
    {
      ...
      title: "BMW M4 - Performance Meets Style", isNew: false, location: "New York",stock:2
    },
    {
      id: 10, brand: "Audi", model: "TT", year: 2022, mileage: 40, maxSpeed: 240,
      price: 5000000, oldPrice: 5200000, image: "audi-tt.jpg", type: "Coupe",
      title: "Audi TT - Pure Driving Joy", isNew: true, location: "Los Angeles",stock:2
    },
    {
    ...
    },
    {
      ...
      title: "Lexus RC - Craftsmanship in Motion", isNew: true, location: "Atlanta",stock:6
    },
    ...
    // Convertibles
    {
      ...
      title: "Mazda MX-5 - Open-Top Freedom", isNew: true, location: "San Diego",stock:15
    },
    {
      ...
      title: "Porsche 911 Cabriolet - Wind in Your Hair", isNew: false, location: "Orlando",stock:7
    },
    {
    ...
    },
    {
      ...
      title: "Camaro Convertible - Wild and Free", isNew: true, location: "San Jose",stock:3
    },
    ...
    // Hatchbacks
    {
      ...
      title: "VW Golf - The Iconic Hatch", isNew: false, location: "Philadelphia",stock:6
    },
    {
      ...
      title: "Ford Focus - Ready for City Life", isNew: true, location: "Austin",stock:4
    },
    {
    ...
    },
    {
      ...
      title: "Honda Fit - Small and Mighty", isNew: false, location: "Portland",stock:7
    },
    ...
    // Crossovers
    {
      ...
      title: "Nissan Rogue - Smooth Versatility", isNew: true, location: "Salt Lake City",stock:9
    },
    {
      ...
      title: "Kia Sportage - Modern Urban Drive", isNew: true, location: "Charlotte",stock:8
    },
    {
      ...
      title: "Mazda CX-30 - Agile City Car", isNew: false, location: "Indianapolis",stock:4
    },
    {
      ...
      title: "Subaru Crosstrek - Trail Ready", isNew: false, location: "Cleveland",stock:2
    },
    ...
    // Pickups
    {
      ...
      title: "Ford F-150 - Built Tough", isNew: true, location: "Detroit",stock:7
    },
    {
    ...
    },
    {
      ...
      title: "Ram 1500 - Power in Your Hands", isNew: true, location: "Nashville",stock:32
    },
    {
      ...
      title: "Toyota Tundra - Strength and Reliability", isNew: false, location: "El Paso",stock:4
    },
    // More SUVs
  {
    ...
    title: "Jeep Grand Cherokee - Off-road Power", isNew: false, location: "Boise",stock:9
  },
  {
    ...
    title: "VW Tiguan - Sophisticated Utility", isNew: true, location: "St. Louis",stock:1
  },
  ...
  // More Sedans
  {
    ...
    title: "BMW 3 Series - Luxury on Wheels", isNew: false, location: "Cincinnati",stock:6
  },
  {
    id: 32, brand: "Audi", model: "A4", year: 2023, mileage: 50, maxSpeed: 245,
    price: 4700000, oldPrice: 4800000, image: "audi-a4.jpg", type: "Sedan",
    title: "Audi A4 - Precision Engineering", isNew: true, location: "New Orleans",stock:7
  },
  ...
  // More Hatchbacks
  {
    ...
    title: "Mini Cooper - Big Fun in Small Package", isNew: false, location: "Pittsburgh",stock:9
  },
  {
    ...
    title: "Toyota Yaris - Efficient and Nimble", isNew: true, location: "Sacramento",stock:2
  },
  ...
  // More Coupes
  {
    ...
    title: "Infiniti Q60 - Bold and Beautiful", isNew: false, location: "Kansas City",stock:8
  },
  {
    ...
    title: "Dodge Challenger - Muscle Redefined", isNew: true, location: "Albuquerque",stock:5
  },
  ...
  // More Convertibles
  {
    ...
    title: "BMW Z4 - Roadster Passion", isNew: false, location: "Columbus",stock:8
  },
  {
    ...
    title: "Mercedes E-Class Cabriolet - Refined Luxury", isNew: true, location: "Raleigh",stock:12
  },
  ...
  // More Crossovers
  {
    ...
    title: "Honda HR-V - Ready for Everything", isNew: false, location: "Fresno",stock:1
  },
  {
    ...
    title: "Toyota C-HR - City Crossover with Flair", isNew: true, location: "Tucson",stock:2
  },
  ...
  // More Pickups
  {
    ...
    title: "GMC Sierra - Truck of the People", isNew: false, location: "Birmingham",stock:8
  },
  {
    ...
    title: "Nissan Frontier - Strength Simplified", isNew: true, location: "Anchorage",stock:2
  },
  ...
  // Mixed types to reach 50
  {
    ...
    title: "Tesla Model Y - Electric Elevation", isNew: true, location: "San Francisco",stock:3
  },
  {
    ...
    title: "Tesla Model 3 - Drive the Future", isNew: false, location: "San Diego",stock:7
  },
  {
    ...
    title: "Volvo XC40 - Compact Safety", isNew: true, location: "Baltimore",stock:8
  },
  {
    ...
    title: "Chevy Bolt - Affordable Electric", isNew: true, location: "Reno",stock:3
  },
  {
    ...
    title: "Fiat 500 - European Charm", isNew: false, location: "Providence",stock:9
  },
  {
    ...
    title: "Santa Cruz - Crossover Meets Truck", isNew: true, location: "Oklahoma City",stock:6
  },
  {
    ...
    title: "Acura Integra - Precision & Prestige", isNew: true, location: "Des Moines",stock:3
  },
  {
    ...
    title: "Jaguar F-Type - Power and Grace", isNew: false, location: "Honolulu",stock:6
  }
  ];
